...
ggp <- ggplotly(A)%>% layout(margin = list(r = 90))
tmpFile <- tempfile(fileext = ".png")
export(ggp, file = tmpFile)
```
...
lm_Fp1 <- clusterlm(signal_Fp1 ~ condition + Error(.subj/(condition)),data = design,
                      )
lm_Fp1
```
...
Therefore, the lower bound for the number of true discoveries is equals $54$, for the true discovery proportion is equal to $62.79\%$.
